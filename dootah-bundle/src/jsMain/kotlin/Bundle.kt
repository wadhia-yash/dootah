...
/**
 * The bundle that ships in the APK: "bundle v1".
 *
 ...
 * ./gradlew buildBundle, and upload the produced bundle with an incremented
 * bundleVersion in the manifest.
 */
...
fun renderScreen(): String {
    ...
    return Column {
        ...
        Text("Weekend Offer")
        Text("Served by Dootah bundle v1")
