...
| Wrong `runtimeVersion` | Publish `"runtimeVersion": "2"` with a higher `bundleVersion` | Rejected as incompatible; installed bundle keeps running |
...
- `runtimeVersion` — exact-match compatibility token against `DOOTAH_RUNTIME_VERSION` (`"1"`
